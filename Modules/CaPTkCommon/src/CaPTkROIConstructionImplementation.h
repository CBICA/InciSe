...
class MITKCAPTKCOMMON_EXPORT ROIConstructionImplementation
{
public:
  //! Some useful aliases
  ...
  /**
  \brief Implementation structure to store the ROI properties for Feature Extraction
  */
...
#endif // ! #ifndef CaPTkROIConstructionImplementation_h
...
#ifndef QMITKCAPTKINTROPART_H_
#define QMITKCAPTKINTROPART_H_

#include <QtCore/qconfig.h>

#include <berryQtIntroPart.h>
#include <ui_QmitkCaPTkWelcomeScreenViewControls.h>


/**
 * \ingroup org_mitk_gui_qt_welcomescreen_internal
 * \brief QmitkCaPTkIntroPart
...
class QmitkCaPTkIntroPart : public berry::QtIntroPart
{
...
protected:
  ...
  Ui::QmitkCaPTkWelcomeScreenViewControls* m_Controls;

  class Impl;
  Impl* m_Impl;
};

#endif /* QMITKCAPTKINTROPART_H_ */
